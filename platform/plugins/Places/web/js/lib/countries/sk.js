Q.Places.countries = [
    ...
    ["Keni","KE"],
    ["Kiribati","KI"],
    ["Kórejská ľudová republika","KP"],
    ["Kórejská republika","KR"],
    ["Kuwait","KW"],
    ["Kirgizsko","KG"],
    ["Lao ľudová demokratická republika","LA"],
    ["Latvia","LV"],
    ["Libanon","LB"],
    ["Lesotho","LS"],
    ["Libéria","LR"],
    ...
    ["Rwanda","RW"],
    ["Svätý Bartolomej","BL"],
    ["Svätá Helena a Tristan da Cunha","SH"],
    ["Svätý Krištof a Nevis","KN"],
    ["Svätá Lucia","LC"],
    ["Svätý Martin (francúzska časť)","MF"],
    ["Saint-Pierre a Miquelon","PM"],
    ["Svätý Vincent a Grenadíny","VC"],
    ["Samoa","WS"],
    ["San Maríno","SM"],
    ["Svätý Tomáš a Princov","ST"],
    ["Saudská Arábia","SA"],
    ["Senegal","SN"],
    ["Srbsko","RS"],
    ["Seychely","SC"],
    ["Sierra Leone","SL"],
    ["Singapore","SG"],
    ["Sint Maarten (holandský časť)","SX"],
    ["Slovensko","SK"],
    ["Slovenia","SI"],
    ...
    ["Tadžikistan","TJ"],
    ["Tanzánia, zjednotená republika","TZ"],
    ["Thailand","TH"],
    ["Východný Timor","TL"],
    ["Togo","TG"],
    ["Tokelau","TK"],
    ...
    ["Spojené štáty","US"],
    ["Menšie odľahlé ostrovy Spojených štátov amerických","UM"],
    ["Uruguaj","UY"],
    ["Uzbekistan","UZ"],
    ["Vanuatu","VU"],
    ["Vatikán","VA"],
