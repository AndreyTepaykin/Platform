Q.Places.countries = [
    ...
    ["Bermuda","BM"],
    ["Bhután","BT"],
    ["Bolíviai Többnemzetiségű Állam","BO"],
    ...
    ["Kenya","KE"],
    ["Kiribati","KI"],
    ["Koreai Demokratikus Népköztársaság","KP"],
    ["Koreai Köztársaság","KR"],
    ["Kuwait","KW"],
    ["Kirgizisztán","KG"],
    ["Lao Népi Demokratikus Köztársaság","LA"],
    ["Lett","LV"],
    ["Libanon","LB"],
    ["Lesotho","LS"],
    ["Libéria","LR"],
    ...
    ["Mayotte","YT"],
    ["Mexikó","MX"],
    ["Mikronéziai Szövetségi Államok","FM"],
    ...
    ["Ruanda","RW"],
    ["Saint Barthélemy","BL"],
    ["Saint Helena és Tristan da Cunha","SH"],
    ["Saint Kitts és Nevis","KN"],
    ["Saint Lucia","LC"],
    ["Saint-Martin (francia rész)","MF"],
    ...
    ["Vanuatu","VU"],
    ["Vatikán","VA"],
    ["Venezuelai Bolivár Köztársaság","VE"],
    ["Vietnam","VN"],
    ["Brit Virgin-szigetek","VG"],
    ["Virgin Islands, Egyesült Államokon kívül.","VI"],
    ["Wallis és Futuna","WF"],
    ["Nyugat-Szahara","EH"],
    ["Jemen","YE"],
    ["Zambia","ZM"],
