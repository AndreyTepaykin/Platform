Q.Places.countries = [
    ...
    ["Kenya","KE"],
    ["Kiribati","KI"],
    ["La Corea, Repubblica democratica popolare di","KP"],
    ["Corea del Sud","KR"],
    ["Il Kuwait","KW"],
    ["Kyrgyzstan","KG"],
    ...
    ["Rwanda","RW"],
    ["Saint Barthélemy","BL"],
    ["Sant'Elena e Tristan da Cunha","SH"],
    ...
    ["Regno Unito","GB"],
    ["Stati Uniti","US"],
    ["degli Stati Uniti Isole Minori","UM"],
    ["Uruguay","UY"],
    ["Uzbekistan","UZ"],
    ["Vanuatu","VU"],
    ["Città del Vaticano","VA"],
    ["Il Venezuela, Repubblica Bolivariana del","VE"],
    ["Vietnam","VN"],
    ["Isole Vergini Britanniche","VG"],
    ["Isole Vergini, fuori degli USA.","VI"],
    ["Wallis e Futuna","WF"],
